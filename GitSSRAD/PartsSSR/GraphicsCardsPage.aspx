<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GraphicsCardsPage.aspx.cs" Inherits="GraphicsCardsPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="gc" Name="CategoryID" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
    <p>
