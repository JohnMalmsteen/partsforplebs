<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PowerSupplyPage.aspx.cs" Inherits="PowerSupplyPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="ps" Name="CategoryID" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
    <p>
