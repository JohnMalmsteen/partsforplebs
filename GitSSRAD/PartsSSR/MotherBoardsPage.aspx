<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MotherBoardsPage.aspx.cs" Inherits="MotherBoardsPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [Name], [ShortDescription], [ImageFile], [UnitPrice], [ProductID] FROM [Products] WHERE ([CategoryID] = @CategoryID)">
            <SelectParameters>
                <asp:Parameter DefaultValue="mb" Name="CategoryID" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
    <p>
